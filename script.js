//TODO 📗 Module 5. Logic and Control Flow - Lesson 11.01: Module Review
...
//!  In the ternary operator syntax condition ? expressionIfTrue : expressionIfFalse, the "?" acts like an IF — it checks the condition and, if true, executes the first expression. The ":" acts like an ELSE — if the condition is false, it executes the second expression.
...
//? 9. B – Sets theme only if it is falsy
...
//  You have demonstrated full mastery of JavaScript logic and control flow at this level. 🧠🚀
